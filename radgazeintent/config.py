...
def add_maskformer2_config(cfg):
    ...
    cfg.MODEL.MASK_FORMER.NORMAL_WEIGHT = 1.0
    ...
    cfg.MODEL.MASK_FORMER.TEST.NORMAL_ON = False
    cfg.MODEL.MASK_FORMER.TEST.DEPTH_ON = False
    cfg.MODEL.MASK_FORMER.TEST.OBJECT_MASK_THRESHOLD = 0.0
    cfg.MODEL.MASK_FORMER.TEST.OVERLAP_THRESHOLD = 0.0
    cfg.MODEL.MASK_FORMER.TEST.SEM_SEG_POSTPROCESSING_BEFORE_INFERENCE = False
    cfg.MODEL.MASK_FORMER.TEST.GT_MASK_NORMAL = False
    ...
    cfg.MODEL.MASK_FORMER.SEG_ON = True
    cfg.MODEL.MASK_FORMER.USE_CONTRASTIVE_LOSS = True
    cfg.MODEL.MASK_FORMER.USE_PER_IMG_LOSS = True
    cfg.MODEL.MASK_FORMER.USE_PER_SEG_LOSS = True
    cfg.MODEL.MASK_FORMER.USE_INTERM_NORMAL_LOSS = False
    cfg.MODEL.MASK_FORMER.USE_MASK_ATTN_NORMAL = True
    cfg.MODEL.MASK_FORMER.USE_SEGMENTAL_NORMAL = True
    cfg.MODEL.MASK_FORMER.SEGMENTATION_AS_AUX = False
    ...
    cfg.TEST.USE_REG_METRICS = False
